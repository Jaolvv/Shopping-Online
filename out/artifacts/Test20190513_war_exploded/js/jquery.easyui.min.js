...
(function ($) {
    ...
    $.fn.tabs = function (_396, _397) {
        ...
        return this.each(function () {
            ...
            if (_398) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _396),
                    tabs: [],
                    selectHis: []
                });
                _34e(this);
    ...
    $.fn.tabs.parseOptions = function (_3a5) {
        return $.extend({}, $.parser.parseOptions(_3a5, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
...
(function ($) {
    ...
    function _3c5(_3c6, _3c7, el) {
        ...
        var _3c9 = $.extend({}, $.fn.layout.paneldefaults, {
            ...
            cls: ((_3c7.cls || "") + " layout-panel layout-panel-" + dir),
            bodyCls: ((_3c7.bodyCls || "") + " layout-body")
        });
        pp.panel(_3c9);
        _3c8[dir] = pp;
        ...
        _3cd.resizable($.extend({}, {
            handles: (_3cc[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _3b5 = true;
    ...
    function _3e2(_3e3, _3e4, _3e5) {
        ...
        function _3e9(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                ...
                title: "&nbsp;",
                titleDirection: _3e7.titleDirection,
                iconCls: (_3e7.hideCollapsedContent ? null : _3e7.iconCls),
                closed: true,
                minWidth: 0,
                minHeight: 0,
                doSize: false,
                region: _3e7.region,
                collapsedSize: _3e7.collapsedSize,
                noheader: (!isns && _3e7.hideExpandTool),
                tools: ((isns && _3e7.hideExpandTool) ? null : [{
        ...
        function _3eb() {
            ...
            if (_3e4 == "east") {
                ...
                return {
                    resizeC: {width: _3f3},
                    expand: {left: cc.width() - _3f2},
                    expandP: {top: _3f0.top, left: cc.width() - _3f1, width: _3f1, height: _3f0.height},
                    collapse: {left: cc.width(), top: _3f0.top, height: _3f0.height}
                };
            } else {
                if (_3e4 == "west") {
                    var _3f2 = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3f3, left: _3f1 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3f0.top, width: _3f1, height: _3f0.height},
                        collapse: {left: -_3f2, top: _3f0.top, height: _3f0.height}
                    };
                } else {
                    if (_3e4 == "north") {
                        ...
                        _3e6.east.add(_3e6.west).add(_3e6.expandEast).add(_3e6.expandWest).panel("resize", {
                            top: _3f1 - 1,
                            height: hh
                        });
                        return {
                            resizeC: {top: _3f1 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3f1},
                            collapse: {top: -_3f4, width: cc.width()}
                        };
                    } else {
                        if (_3e4 == "south") {
                            var _3f4 = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3f4},
                                expandP: {top: cc.height() - _3f1, left: 0, width: cc.width(), height: _3f1},
    ...
    function _3f5(_3f6, _3f7) {
        ...
        function _3fc() {
            ...
            if (_3f7 == "east" && _3f8.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _3fd.top, height: _3fd.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3f7 == "west" && _3f8.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _3fd.top, height: _3fd.height},
                        expand: {left: 0}
                    };
                } else {
    ...
    $.fn.layout.defaults = {
        fit: false, onExpand: function (_416) {
    ...
    $.fn.layout.parsePanelOptions = function (_41a) {
        var t = $(_41a);
        return $.extend({}, $.fn.panel.parseOptions(_41a), $.parser.parseOptions(_41a, ["region", {
            split: "boolean",
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        ...
        collapsedContent: function (_41b) {
            var p = $(this);
...
(function ($) {
    ...
    function _425(_428, div, _429) {
        var item = $(div);
        var _42a = $.extend({}, $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {separator: "boolean"}]), {
    ...
    function _426(_42c, menu) {
        ...
        menu.show();
        menu._size($.extend({}, _42f, {
            width: _430,
            height: _431,
            minWidth: _42f.minWidth || opts.minWidth,
            maxWidth: _42f.maxWidth || opts.maxWidth
        }));
    ...
    $.fn.menu.parseOptions = function (_471) {
        return $.extend({}, $.parser.parseOptions(_471, [{
            minWidth: "number",
            itemHeight: "number",
            duration: "number",
    ...
    $.fn.menu.defaults = {
        ...
        fit: false,
        noline: false,
        events: {mouseenter: _436, mouseleave: _439, mouseover: _43d, mouseout: _440, click: _442},
        position: function (_472, left, top) {
            return {left: left, top: top};
        },
        onShow: function () {
        },
...
(function ($) {
    ...
    $.fn.menubutton.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "menubutton").options, {
                toggle: _484.toggle,
                selected: _484.selected,
                disabled: _484.disabled
            });
        }, destroy: function (jq) {
            return jq.each(function () {
    ...
    $.fn.menubutton.parseOptions = function (_485) {
        var t = $(_485);
        return $.extend({}, $.fn.linkbutton.parseOptions(_485), $.parser.parseOptions(_485, ["menu", {
            plain: "boolean",
...
(function ($) {
    ...
    $.fn.splitbutton.parseOptions = function (_48d) {
        var t = $(_48d);
        return $.extend({}, $.fn.linkbutton.parseOptions(_48d), $.parser.parseOptions(_48d, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
    ...
    function _491(_492, _493) {
        ...
        _495.find(".switchbutton-on").css({
            width: (w - _497 / 2) + "px",
            textIndent: (opts.reversed ? "" : "-") + _497 / 2 + "px"
        });
        _495.find(".switchbutton-off").css({
            width: (w - _497 / 2) + "px",
            textIndent: (opts.reversed ? "-" : "") + _497 / 2 + "px"
        });
    ...
    $.fn.switchbutton = function (_4b4, _4b5) {
        ...
        return this.each(function () {
            ...
            if (_4b6) {
                ...
                _4b6 = $.data(this, "switchbutton", {
                    options: $.extend({}, $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _4b4),
    ...
    $.fn.switchbutton.parseOptions = function (_4ba) {
        var t = $(_4ba);
        return $.extend({}, $.parser.parseOptions(_4ba, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
        }]), {
...
(function ($) {
    ...
    $.fn.validatebox.parseOptions = function (_4ec) {
        var t = $(_4ec);
        return $.extend({}, $.parser.parseOptions(_4ec, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            interval: "number",
            deltaX: "number"
        }, {
    ...
    $.fn.validatebox.defaults = {
        ...
        events: {
            focus: _4c3, blur: _4c7, mouseenter: _4ca, mouseleave: _4cd, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _505(_506, _507) {
        ...
        _50b.css({
            paddingLeft: (_506.style.paddingLeft || ""),
            paddingRight: (_506.style.paddingRight || ""),
            marginLeft: _511("left"),
            marginRight: _511("right"),
            marginTop: _50f("top"),
            marginBottom: _50f("bottom")
        });
        if (opts.multiline) {
    ...
    function _4ff(_514) {
        ...
        _515.validatebox($.extend({}, opts, {
            deltaX: function (_516) {
    ...
    $.fn.textbox = function (_529, _52a) {
        ...
        return this.each(function () {
            ...
            if (_52d) {
                ...
                _52d = $.data(this, "textbox", {
                    options: $.extend({}, $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _529),
                    textbox: init(this)
                });
    ...
    $.fn.textbox.parseOptions = function (_548) {
        var t = $(_548);
        return $.extend({}, $.fn.validatebox.parseOptions(_548), $.parser.parseOptions(_548, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", "label", "labelPosition", "labelAlign", {
            multiline: "boolean",
            iconWidth: "number",
            labelWidth: "number"
...
(function ($) {
    ...
    $.fn.passwordbox.parseOptions = function (_568) {
        return $.extend({}, $.fn.textbox.parseOptions(_568), $.parser.parseOptions(_568, ["passwordChar", {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        revealed: false,
        showEye: true,
        inputEvents: {focus: _55c, blur: _560},
        val: function (_569) {
...
(function ($) {
    function _577(_578) {
        ...
        function _57e(item) {
            ...
            $(_578).textbox("button").menubutton({
                text: item.text,
...
(function ($) {
    ...
    function load(_5a0, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _5a1, dataType: "json", success: function (data) {
                    _5a2(data);
                }, error: function () {
    ...
    $.fn.form.parseOptions = function (_5bf) {
        var t = $(_5bf);
        return $.extend({}, $.parser.parseOptions(_5bf, [{
            ajax: "boolean",
            dirty: "boolean"
...
(function ($) {
    ...
    $.fn.numberbox.parseOptions = function (_5d3) {
        var t = $(_5d3);
        return $.extend({}, $.fn.textbox.parseOptions(_5d3), $.parser.parseOptions(_5d3, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
...
(function ($) {
    ...
    $.fn.calendar.parseOptions = function (_605) {
        var t = $(_605);
        return $.extend({}, $.parser.parseOptions(_605, ["weekNumberHeader", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean",
            showWeek: "boolean"
...
(function ($) {
    function _60a(_60b) {
        ...
        $(_60b).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _60d, doSize: false, onResize: function (_60f, _610) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
    ...
    $.fn.spinner.parseOptions = function (_61e) {
        return $.extend({}, $.fn.textbox.parseOptions(_61e), $.parser.parseOptions(_61e, ["min", "max", "spinAlign", {
            increment: "number",
            reversed: "boolean"
        }]));
    };
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_63e) {
        return $.extend({}, $.fn.spinner.parseOptions(_63e), $.parser.parseOptions(_63e, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
...
(function ($) {
    ...
    function _665(_666) {
        ...
        _66a.add(_66b).children("div.datagrid-body").css({
            marginTop: _671,
            height: (isNaN(parseInt(opts.height)) ? "" : (_669 - _672)),
            minHeight: (_674 ? _674 - _673 - _672 : ""),
            maxHeight: (_675 ? _675 - _673 - _672 : "")
        });
    ...
    function _68a(_68b, _68c) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _691,
                view2: _692,
                header1: _691.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _692.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1: _691.children("div.datagrid-body").children("div.datagrid-body-inner"),
                body2: _692.children("div.datagrid-body"),
                footer1: _691.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
                footer2: _692.children("div.datagrid-footer").children("div.datagrid-footer-inner")
            }
        };
    };
    ...
    function _693(_694) {
        ...
        _696.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_697, _698) {
        ...
        if (opts.pagination) {
            ...
            _69b.pagination({
                ...
                onSelectPage: function (_69c, _69d) {
            ...
            if (col && col.editor) {
                ...
                if (_793) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _793,
                        target: _793.init(cell.find("td"), $.extend({height: opts.editorHeight}, _792)),
                        field: _790,
                        type: _791,
                        oldHtml: _794
                    });
    ...
    var _7e3 = $.extend({}, _7d5(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_7e4, _7e5) {
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_7fc, {
                width: _7fd.width,
                height: _7fd.height,
                closed: _7fd.closed,
                collapsed: _7fd.collapsed,
                minimized: _7fd.minimized,
                maximized: _7fd.maximized
            });
            return opts;
    ...
    $.fn.datagrid.parseOptions = function (_829) {
        var t = $(_829);
        return $.extend({}, $.fn.panel.parseOptions(_829), $.parser.parseOptions(_829, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 24,
        headerEvents: {mouseover: _6b4(true), mouseout: _6b4(false), click: _6b8, dblclick: _6bd, contextmenu: _6c0},
        rowEvents: {mouseover: _6c2(true), mouseout: _6c2(false), click: _6c9, dblclick: _6d3, contextmenu: _6d7},
        rowStyler: function (_872, _873) {
        },
        loader: function (_874, _875, _876) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _874, dataType: "json", success: function (data) {
                    _875(data);
                }, error: function () {
        ...
        editors: _7e3,
        finder: {
            getTr: function (_877, _878, type, _879) {
                type = type || "body";
                _879 = _879 || 0;
...
(function ($) {
    ...
    function _8ae(_8af) {
        ...
        $(_8af).datagrid($.extend({}, opts, {
            cls: "propertygrid",
            view: (opts.showGroup ? opts.groupView : opts.view),
            onBeforeEdit: function (_8b1, row) {
    ...
    var _8bd = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_8be, _8bf, _8c0) {
            var _8c1 = [];
    ...
    $.extend(_8bd, {
        refreshGroupTitle: function (_8e4, _8e5) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupView: _8bd,
        groupField: "group",
        groupFormatter: function (_8fe, rows) {
            return _8fe;
        }
    });
})(jQuery);
(function ($) {
    function _8ff(_900) {
        ...
        if (opts.pagination) {
            ...
            _90c.pagination({
                ...
                pageSize: opts.pageSize,
                pageList: opts.pageList,
                onSelectPage: function (_90d, _90e) {
    ...
    $.fn.treegrid = function (_994, _995) {
        ...
        return this.each(function () {
            ...
            if (_997) {
                ...
                _997 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _994),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.parseOptions = function (_9a3) {
        return $.extend({}, $.fn.datagrid.parseOptions(_9a3), $.parser.parseOptions(_9a3, ["treeField", {
            checkbox: "boolean",
            cascadeCheck: "boolean",
            onlyLeafCheck: "boolean"
        }, {animate: "boolean"}]));
    };
    var _9a4 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9a5, _9a6, _9a7) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_9e2, _9e3, _9e4) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _9e2, dataType: "json", success: function (data) {
                    _9e3(data);
                }, error: function () {
        ...
        finder: {
            getTr: function (_9e6, id, type, _9e7) {
                type = type || "body";
                _9e7 = _9e7 || 0;
...
(function ($) {
    function _9f0(_9f1) {
        ...
        $(_9f1).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_9f2, row, _9f3) {
                    return opts.textFormatter ? opts.textFormatter(_9f2, row, _9f3) : _9f2;
                }
            }]]
        }));
    };
    var _9f4 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9f5, _9f6, _9f7) {
    ...
    $.fn.datalist.parseOptions = function (_a0d) {
        return $.extend({}, $.fn.datagrid.parseOptions(_a0d), $.parser.parseOptions(_a0d, ["valueField", "textField", "groupField", {
            checkbox: "boolean",
            lines: "boolean"
        }]));
    };
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupField: "",
        view: _9f4,
        textFormatter: function (_a10, row) {
            return _a10;
        },
...
(function ($) {
    ...
    function _a13(_a14) {
        ...
        $(_a14).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _a1a, onChange: function () {
            }
        }));
    ...
    function _a2c(_a2d) {
        ...
        if (_a31.closed) {
            _a30.panel("panel").show().css({
                zIndex: ($.fn.menu ? $.fn.menu.defaults.zIndex++ : ($.fn.window ? $.fn.window.defaults.zIndex++ : 99)),
                left: -999999
            });
            _a30.panel("resize", {
                width: (opts.panelWidth ? opts.panelWidth : _a2f._outerWidth()),
    ...
    $.fn.combo = function (_a52, _a53) {
        ...
        return this.each(function () {
            ...
            if (_a55) {
                ...
                _a55 = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _a52),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function (_a58) {
        var t = $(_a58);
        return $.extend({}, $.fn.textbox.parseOptions(_a58), $.parser.parseOptions(_a58, ["separator", "panelAlign", {
            panelWidth: "number",
            hasDownArrow: "boolean",
            delay: "number",
            reversed: "boolean",
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _a25, keydown: _a29, paste: _a29, drop: _a29},
        panelEvents: {
...
(function ($) {
    ...
    $.fn.combobox = function (_a9c, _a9d) {
        ...
        return this.each(function () {
            ...
            if (_a9f) {
                ...
                _a9f = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _a9c),
                    data: []
                });
            }
            _a8e(this);
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width: _aa0.width,
                height: _aa0.height,
                originalValue: _aa0.originalValue,
                disabled: _aa0.disabled,
                readonly: _aa0.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
    ...
    $.fn.combobox.parseOptions = function (_aa7) {
        var t = $(_aa7);
        return $.extend({}, $.fn.combo.parseOptions(_aa7), $.parser.parseOptions(_aa7, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
    ...
    var _aac = 0;
    var _aad = {
        render: function (_aae, _aaf, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        panelEvents: {
            mouseover: _a91, mouseout: _a92, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _a93, scroll: _a96
        },
        ...
        loader: function (_ab6, _ab7, _ab8) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _ab6, dataType: "json", success: function (data) {
                    _ab7(data);
                }, error: function () {
    ...
    $.fn.combotree.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotree").options, {
                width: _aea.width,
                height: _aea.height,
                originalValue: _aea.originalValue,
                disabled: _aea.disabled,
                readonly: _aea.readonly
            });
...
(function ($) {
    function _af0(_af1) {
        ...
        var grid = _af2.grid;
        $(_af1).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                dg.datagrid("resize", {
                    ...
                    minHeight: (_af4 ? _af4 - _af3 : ""),
                    maxHeight: (_af5 ? _af5 - _af3 : "")
                });
        ...
        grid.datagrid($.extend({}, opts, {
            ...
            onLoadSuccess: _af7,
            onClickRow: _af8,
            onSelect: _af9("onSelect"),
            onUnselect: _af9("onUnselect"),
            onSelectAll: _af9("onSelectAll"),
            onUnselectAll: _af9("onUnselectAll")
        }));
...
(function ($) {
    function _b32(_b33) {
        ...
        $(_b33).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                dg.treegrid("resize", {
                    width: "100%",
                    height: (isNaN(parseInt(opts.panelHeight)) ? "auto" : "100%"),
                    minHeight: (_b36 ? _b36 - _b35 : ""),
                    maxHeight: (_b37 ? _b37 - _b35 : "")
                });
        ...
        _b34.grid.treegrid($.extend({}, opts, {
    ...
    $.fn.combotreegrid.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotreegrid").options, {
                width: _b53.width,
                height: _b53.height,
                originalValue: _b53.originalValue,
                disabled: _b53.disabled,
                readonly: _b53.readonly
            });
        }, grid: function (jq) {
...
(function ($) {
    function _b59(_b5a) {
        ...
        $(_b5a).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_b5c, _b5d) {
                _b5e();
    ...
    function _b74(_b75) {
        ...
        tmp.css({
            ...
            left: -9999,
            width: "auto",
            fontFamily: _b76.css("fontFamily"),
            fontSize: _b76.css("fontSize"),
            fontWeight: _b76.css("fontWeight"),
            whiteSpace: "nowrap"
        });
    ...
    $.fn.tagbox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "tagbox").options, {
                width: _b87.width,
                height: _b87.height,
                originalValue: _b87.originalValue,
                disabled: _b87.disabled,
                readonly: _b87.readonly
            });
...
(function ($) {
    function _b91(_b92) {
        ...
        $(_b92).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _b94(this);
                _b95(this);
                _b96(this);
        ...
        if (!_b93.calendar) {
            ...
            $.extend(_b93.calendar.calendar("options"), {
    ...
    $.fn.datebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datebox").options, {
                width: _bb2.width,
                height: _bb2.height,
                originalValue: _bb2.originalValue,
                disabled: _bb2.disabled,
                readonly: _bb2.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
                $(this).combo("cloneFrom", from);
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        panelWidth: 180, panelHeight: "auto", sharedCalendar: null, keyHandler: {
            ...
            text: function (_bb7) {
                ...
                $(_bb8).datebox("calendar").calendar({
                    year: _bb9.getFullYear(),
                    month: _bb9.getMonth() + 1,
                    current: _bb9
                });
...
(function ($) {
    function _bbc(_bbd) {
        ...
        $(_bbd).datebox("calendar").calendar({
            onSelect: function (date) {
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _bd2.originalValue,
                disabled: _bd2.disabled,
                readonly: _bd2.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
...
(function ($) {
    ...
    function _bf3(_bf4) {
        ...
        _bf6.find("a.slider-handle").draggable({
    ...
    $.fn.slider = function (_c13, _c14) {
        ...
        return this.each(function () {
            ...
            if (_c15) {
                ...
                _c15 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _c13),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_c19) {
        var t = $(_c19);
        return $.extend({}, $.parser.parseOptions(_c19, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_c1a) {
            return _c1a;
        },
        converter: {
            toPosition: function (_c1b, size) {
                var opts = $(this).slider("options");
